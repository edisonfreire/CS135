...
Write a program that creates an array of 10 integers, and provides the user with an interface to edit any of its elements.
*/
...
int main(){
   ...
   do {
      ...
      cout << "Input value: ";
      cin >> v;
      if (i >= 0 && i < 10){ //if the inputted index is in range, the array is updated at index i
         myData[i] = v;
      }
